#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER v6.9.222 - DRAMATICALLY IMPROVED
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download 6.9.222                     # Download specific version
    ${SCRIPT_NAME} install 6.9.222                      # Install specific version
