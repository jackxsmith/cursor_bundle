#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER vv6.9.230 - DRAMATICALLY IMPROVED
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download v6.9.230                     # Download specific version
    ${SCRIPT_NAME} install v6.9.230                      # Install specific version
