#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER v6.9.208 - DRAMATICALLY IMPROVED
...
# === CONFIGURATION ===
readonly SCRIPT_VERSION="6.9.208"
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download 6.9.210                     # Download specific version
    ${SCRIPT_NAME} install 6.9.210                      # Install specific version
