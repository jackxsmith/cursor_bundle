#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER vtracker-system-v2 - DRAMATICALLY IMPROVED
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download tracker-system-v2                     # Download specific version
    ${SCRIPT_NAME} install tracker-system-v2                      # Install specific version
