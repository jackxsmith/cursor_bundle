#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER v6.9.224 - DRAMATICALLY IMPROVED
...
# === CONFIGURATION ===
readonly SCRIPT_VERSION="6.9.224"
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download 6.9.224                     # Download specific version
    ${SCRIPT_NAME} install 6.9.224                      # Install specific version
