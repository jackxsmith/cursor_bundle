#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER v6.9.227 - DRAMATICALLY IMPROVED
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download 6.9.227                     # Download specific version
    ${SCRIPT_NAME} install 6.9.227                      # Install specific version
