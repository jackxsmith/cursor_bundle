#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER v6.9.218 - DRAMATICALLY IMPROVED
...
# === CONFIGURATION ===
readonly SCRIPT_VERSION="6.9.218"
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download 6.9.218                     # Download specific version
    ${SCRIPT_NAME} install 6.9.218                      # Install specific version
