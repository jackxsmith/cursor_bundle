#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER v6.9.212 - DRAMATICALLY IMPROVED
...
# === CONFIGURATION ===
readonly SCRIPT_VERSION="6.9.212"
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download 6.9.212                     # Download specific version
    ${SCRIPT_NAME} install 6.9.212                      # Install specific version
