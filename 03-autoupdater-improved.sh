#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER vv6.9.228 - DRAMATICALLY IMPROVED
...
# === CONFIGURATION ===
readonly SCRIPT_VERSION="v6.9.228"
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download v6.9.228                     # Download specific version
    ${SCRIPT_NAME} install v6.9.228                      # Install specific version
