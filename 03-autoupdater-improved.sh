#!/usr/bin/env bash
# 
# 🔄 CURSOR BUNDLE AUTO-UPDATER vdocker-deployment-v2 - DRAMATICALLY IMPROVED
...
${BOLD}EXAMPLES:${NC}
    ...
    ${SCRIPT_NAME} download docker-deployment-v2                     # Download specific version
    ${SCRIPT_NAME} install docker-deployment-v2                      # Install specific version
