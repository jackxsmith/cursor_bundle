#!/usr/bin/env python3
"""
07‑tkinter_v6.9.34_fixed.py – simple Tkinter GUI installer for the Cursor IDE.
...
installer (`install_v6.9.34.sh`) and presents a small window with
...
def run_installer(script_path: str, mode: str, progress: ttk.Progressbar, root: tk.Tk) -> None:
    ...
    :param script_path: Path to the install_v6.9.34.sh wrapper
...
def main() -> None:
    ...
    install_script = os.path.join(script_dir, "install_v6.9.34.sh")
    ...
    root = tk.Tk()
    root.title("Cursor Installer v6.9.34")
