#!/usr/bin/env python3
"""
07‑tkinter_v6.9.35_fixed.py – simple Tkinter GUI installer for the Cursor IDE.
...
installer (`install_v6.9.35.sh`) and presents a small window with
...
def run_installer(script_path: str, mode: str, progress: ttk.Progressbar, root: tk.Tk) -> None:
    ...
    :param script_path: Path to the install_v6.9.35.sh wrapper
...
def main() -> None:
    ...
    root = tk.Tk()
    root.title("Cursor Installer v6.9.35")
