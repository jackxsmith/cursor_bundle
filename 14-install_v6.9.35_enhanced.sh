...
# 14-install_v6.9.35_enhanced.sh — Cursor v6.9.35 Enhanced Installer
...
APPIMAGE="$BUNDLE_DIR/01-appimage_v6.9.35.AppImage"
PREINSTALL_SCRIPTS=("$BUNDLE_DIR"/*preinstall*_v6.9.35.sh)
INSTALLER="$BUNDLE_DIR/14-install_v6.9.35_enhanced.sh"
...
show_version() {
  ...
  echo "Bundle contains Cursor IDE v6.9.35 AppImage"
...
EOF
  ...
  local postinstall_scripts=("$BUNDLE_DIR"/*postinstall*_v6.9.35.sh)
...
main() {
  ...
  local test_suite="$BUNDLE_DIR/22-test_cursor_suite_v6.9.35_fixed.sh"
