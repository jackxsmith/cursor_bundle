...
# ============================================================================
# tracker_v6.9.34.sh
# Tracks function names and confirms script completeness for Cursor v6.9.34
# ============================================================================
...
log ""
log "Verifying 17-policycheck_v6.9.34_fixed.sh presence..."

POLICY_SCRIPT="$TARGET_DIR/17-policycheck_v6.9.34_fixed.sh"

if [[ ! -f "$POLICY_SCRIPT" ]]; then
echo "[ERROR] 17-policycheck_v6.9.34_fixed.sh is missing"
exit 2
fi
...
log ""
log "Confirming .version matches v6.9.34..."
