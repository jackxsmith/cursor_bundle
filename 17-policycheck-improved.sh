...
# ============================================================================
# 17-policycheck-improved.sh - Enterprise Policy Compliance Framework vpolicycheck-framework-v2
...
display_usage() {
    cat << 'EOF'
Enterprise Policy Compliance Framework vpolicycheck-framework-v2
