...
# ============================================================================
# 17-policycheck-improved.sh - Enterprise Policy Compliance Framework v22-test-cursor-suite-improved-v2.sh
...
display_usage() {
    cat << 'EOF'
Enterprise Policy Compliance Framework v22-test-cursor-suite-improved-v2.sh
