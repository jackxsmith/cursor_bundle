...
# ============================================================================
# 22-test-cursor-suite-improved.sh - Enterprise Testing Framework v22-test-cursor-suite-improved-v2.sh
# Comprehensive testing suite for Cursor IDE with advanced validation and reporting
# ============================================================================

readonly SCRIPT_NAME="$(basename "${BASH_SOURCE[0]}")"
readonly SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
readonly VERSION="22-test-cursor-suite-improved-v2.sh"
...
<body>
    ...
    <div class="footer">
        <p>Enterprise Testing Framework v22-test-cursor-suite-improved-v2.sh | Generated by Cursor IDE Test Suite</p>
    </div>
</body>
</html>
EOF
...
display_usage() {
    cat << 'EOF'
Enterprise Testing Framework v22-test-cursor-suite-improved-v2.sh
