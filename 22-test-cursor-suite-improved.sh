...
# ============================================================================
# 22-test-cursor-suite-improved.sh - Enterprise Testing Framework v09-zenity-improved-v2.sh
...
<body>
    ...
    <div class="footer">
        <p>Enterprise Testing Framework v09-zenity-improved-v2.sh | Generated by Cursor IDE Test Suite</p>
    </div>
</body>
</html>
EOF
...
display_usage() {
    cat << 'EOF'
Enterprise Testing Framework v09-zenity-improved-v2.sh
