...
# ============================================================================
# 22-test-cursor-suite-improved.sh - Enterprise Testing Framework vinstall-framework-v2
...
<body>
    ...
    <div class="footer">
        <p>Enterprise Testing Framework vinstall-framework-v2 | Generated by Cursor IDE Test Suite</p>
    </div>
</body>
</html>
EOF
...
display_usage() {
    cat << 'EOF'
Enterprise Testing Framework vinstall-framework-v2
