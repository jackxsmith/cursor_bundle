...
# ============================================================================
# 22-test-cursor-suite-improved.sh - Enterprise Testing Framework v07-tkinter-improved-v2.py
...
<body>
    ...
    <div class="footer">
        <p>Enterprise Testing Framework v07-tkinter-improved-v2.py | Generated by Cursor IDE Test Suite</p>
    </div>
</body>
</html>
EOF
...
display_usage() {
    cat << 'EOF'
Enterprise Testing Framework v07-tkinter-improved-v2.py
