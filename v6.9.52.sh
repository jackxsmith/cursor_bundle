...
# Purpose
# -------
# • Bump project from 6.9.56 → 6.9.56.
...
# Policies v6.9.56
* Exactly one artefact/log is kept for each logical file, suffixed `_v6.9.56`.  Older duplicates (v6.9.35–51) are removed.
...
* Commits are made on a new branch named `v6.9.56`; this branch and the associated tag are pushed to the `origin` remote.
EOF
